...
- `theme.root` accepts raw CSS/Sass strings.
- `theme.components.*` accepts raw CSS/Sass strings for that target selector.
- To author larger Sass files with syntax highlighting and mixins, import `*.scss?inline` and pass the resulting string.
