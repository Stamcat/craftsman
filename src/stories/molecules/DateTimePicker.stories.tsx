...
const WithValueStory = (args: React.ComponentProps<typeof DateTimePicker>) => {
    ...
    return <DateTimePicker {...args} label="Appointment" value={value} onChange={setValue} />;
};
...
const RequiredStory = (args: React.ComponentProps<typeof DateTimePicker>) => {
    const [value, setValue] = useState<DateTimePickerProps["value"]>(null);
    return <DateTimePicker {...args} label="Meeting Time" required value={value} onChange={setValue} />;
};
...
const WithErrorStory = (args: React.ComponentProps<typeof DateTimePicker>) => {
    const [value, setValue] = useState<DateTimePickerProps["value"]>(null);
    return <DateTimePicker {...args} label="Scheduled At" error="Please select a valid date and time." value={value} onChange={setValue} />;
};
