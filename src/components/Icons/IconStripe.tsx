...
export const IconStripe = ({ width = 40, ...props }: SVGIconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="54 36 360.02 149.84" width={width} {...props}>
        <path
            fill="#635bff"
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        <rect fill="#635bff" fillRule="evenodd" clipRule="evenodd" x="223.8" y="69.3" width="25.1" height="87.5" />
        <path
            fill="#635bff"
            fillRule="evenodd"
            clipRule="evenodd"
